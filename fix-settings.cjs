...
const replacement = `
          ...
          {!firebaseUser ? (
            <div className="flex flex-col items-center p-6 bg-neutral-50 rounded-2xl border border-neutral-100">
              <p className="text-sm text-neutral-500 mb-4 text-center">Para usar o aplicativo, você precisa se autenticar.</p>
              <button 
                onClick={handleLogin}
...
code = code.replace(/          <div className="flex items-start justify-between mb-6">[\s\S]*?<\/section>/, replacement);
